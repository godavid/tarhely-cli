#!/usr/bin/env node
// Parancssori belépési pont. Egy parancs = egy függvény, a kimenet és a
// kilépési kód a Reporteren át megy, hogy a `--json` mód egységes legyen.
...
if (isDirectRun || process.env.TARHELY_CLI_MAIN === "1") {
